...
class GetMealByIdTest{
    ...
    lateinit var getMealById: GetMealById

    @Before
    fun onBefore(){
        MockKAnnotations.init(this)
        getMealById = GetMealById(mealRepository)
    }
    ...
    fun returnMealList() = runBlocking {
        ...
        coEvery { mealRepository.getMealById("12345") } returns mealsList

        //When
        val res = getMealById("12345")

        //Then
        coVerify(exactly = 1){ mealRepository.getMealById("12345") }
